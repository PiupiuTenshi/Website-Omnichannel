        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_ShoppingCarts_Owner", "([SessionId] IS NOT NULL AND [UserId] IS NULL) OR ([SessionId] IS NULL AND [UserId] IS NOT NULL)");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ShoppingCartItems_ShoppingCartId_ProductVariantId",
                table: "ShoppingCartItems",
            ...
            migrationBuilder.CreateIndex(
                ...
                column: "SessionId",
                unique: true,
                filter: "[SessionId] IS NOT NULL AND [IsMerged] = 0");
            ...
            migrationBuilder.CreateIndex(
                ...
                column: "UserId",
                unique: true,
                filter: "[UserId] IS NOT NULL AND [IsMerged] = 0");
        }
