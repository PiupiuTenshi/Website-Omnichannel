...
export function CartPage() {
  ...
  async function updateQuantity(productVariantId: string, quantity: number) { try { await setCartItem(productVariantId, quantity); setReservationMessage(""); } catch { setError("Không thể cập nhật số lượng."); } }
  async function removeItem(productVariantId: string) { try { await removeCartItem(productVariantId); setReservationMessage(""); } catch { setError("Không thể xóa sản phẩm."); } }
